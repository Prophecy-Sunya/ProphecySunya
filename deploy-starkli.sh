...
PREDICTION_ADDRESS=$(starkli declare --rpc http://starknet-devnet:5050 --class-hash ${PREDICTION_CLASS_HASH:-0x123456} --watch)
echo "Prediction Contract deployed at: $PREDICTION_ADDRESS"

# Deploy NFT Contract
echo "Deploying NFT Contract..."
NFT_ADDRESS=$(starkli declare --rpc http://starknet-devnet:5050 --class-hash ${NFT_CLASS_HASH:-0x234567} --watch)
echo "NFT Contract deployed at: $NFT_ADDRESS"

# Deploy Gas Tank Contract
echo "Deploying Gas Tank Contract..."
GAS_TANK_ADDRESS=$(starkli declare --rpc http://starknet-devnet:5050 --class-hash ${GAS_TANK_CLASS_HASH:-0x345678} --watch)
echo "Gas Tank Contract deployed at: $GAS_TANK_ADDRESS"

# Deploy Oracle Contract
echo "Deploying Oracle Contract..."
ORACLE_ADDRESS=$(starkli declare --rpc http://starknet-devnet:5050 --class-hash ${ORACLE_CLASS_HASH:-0x456789} --watch)
echo "Oracle Contract deployed at: $ORACLE_ADDRESS"

# Deploy Governance Contract
echo "Deploying Governance Contract..."
GOVERNANCE_ADDRESS=$(starkli declare --rpc http://starknet-devnet:5050 --class-hash ${GOVERNANCE_CLASS_HASH:-0x567890} --watch)
echo "Governance Contract deployed at: $GOVERNANCE_ADDRESS"

# Deploy Bridge Contract
echo "Deploying Bridge Contract..."
BRIDGE_ADDRESS=$(starkli declare --rpc http://starknet-devnet:5050 --class-hash ${BRIDGE_CLASS_HASH:-0x678901} --watch)
